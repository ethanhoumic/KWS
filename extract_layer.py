...
def integer_forward(pth_path: str, pruned_pth_path: str,
    ...
    model.relu1.register_forward_hook(make_hook('relu1_out'))
    model.relu2.register_forward_hook(make_hook('relu2_out'))
    model.linear.register_forward_hook(make_hook('linear_out'))
    model.relu3.register_forward_hook(make_hook('relu3_out'))
    ...
    quantize_and_save('relu1_out',  'relu1',  'relu1_q.txt')
    ...
    print("="*60)
    print("  input_q, relu1_q, relu2_q, linear_q, relu3_q, classifier_out")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pruned_pth', default='./model_params/pruned_cosinelr_75.pth',
